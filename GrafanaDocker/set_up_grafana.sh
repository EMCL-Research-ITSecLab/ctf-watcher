...
DASHBOARD_COMMANDS_UID_JSON="config/commands_dashboard_uid.json"
...
sed -e "s/\${DS_WAZUH-2}/$DATASOURCE_WAZUH_UID/g" -e "s/\${DS_CADVISOR}/$DATASOURCE_CADVISOR_UID/g" "$DASHBOARD_WAZUH_JSON" > "$DASHBOARD_WAZUH_UID_JSON"
sed -e "s/\${DS_WAZUH-2}/$DATASOURCE_WAZUH_UID/g" -e "s/\${DS_CADVISOR}/$DATASOURCE_CADVISOR_UID/g" "$DASHBOARD_CADVISOR_JSON" > "$DASHBOARD_CADVISOR_UID_JSON"
sed -e "s/\${DS_WAZUH-2}/$DATASOURCE_WAZUH_UID/g" -e "s/\${DS_CADVISOR}/$DATASOURCE_CADVISOR_UID/g" "$DASHBOARD_COMMANDS_JSON" > "$DASHBOARD_COMMANDS_UID_JSON"
